...
- Ph.D. researcher in **Computer Vision**
- Research interests in **3D Scene Understanding, 3D Gaussian Splatting (3DGS), Neural Rendering, Scene Reconstruction, and AI-driven Scene Generation**
- Passionate about advancing intelligent perception and immersive 3D environments

### 💻 Engineering

- Full-Stack Development (React, Next.js,Nestjs , FastAPI, Django)
- AI & Machine Learning Engineering
- Computer Vision & Deep Learning
- REST APIs & Distributed Systems
- PostgreSQL, SQLite & Data Engineering
- Docker, Linux & Cloud-native Development
